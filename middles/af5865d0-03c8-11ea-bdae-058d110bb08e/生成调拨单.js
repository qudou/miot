        ...
        fun: function (sys, items, opts) {
            ...
            function read() {
                return new Promise(resolve => {
                    let stmt = `SELECT ${Name}.*,条码,品名,系数,进货价,零售价,分类,迎宾街.库存量 AS 迎宾街库存量 FROM ${Name},迎宾街,商品资料 WHERE ${Name}.货号 = 商品资料.货号 AND ${Name}.是否收藏 = 1 AND ${Name}.货号 = 迎宾街.货号 AND ${Name}.需求量 > 0 AND ${Name}.供应商 = '31043' ORDER BY 零售价`;
