...
$_().imports({
    Index: {
        ...
        xml: "<div id='index'>\
				  <i:ViewStack id='stack' xmlns:i='//xp'>\
					<Content id='content'/>\
					<Login id='login'/>\
				  </i:ViewStack>\
    ...
    Applet: {
        ...
        fun: function (sys, items, opts) {
            ...
            this.watch("/ui/app", (e, app) => {
                ...
                view && opts.mid == app.mid && view.notify(app.topic, [app.data]);
            });
            function load(app) {
...
$_("content/popup").imports({
    List: {
        css: "#list { height: 100%; -webkit-transition-duration: .3s; transition-duration: .3s; position: absolute; left: 0; bottom: 0; z-index: 13500; width: 100%; -webkit-transform: translate3d(0,100%,0); transform: translate3d(0,100%,0); max-height: 100%; -webkit-overflow-scrolling: touch; }\
              #mask { z-index: auto; visibility: visible; opacity: 1; }\
	...
	Mask: {
		xml: "<div id='preload'/>",
		map: { extend: { from: "//xp/preload/Preload" } }
	}
});
